...
def _exec_ssh(filename):
    ...
    #_ret = print(subprocess.Popen(bashCommand2, stdout=subprocess.PIPE).stdout.read())
    ret = os.popen(bashCommand2).read()
    #_ret = print(os.popen(bashCommand2).read())
    #proc = subprocess.Popen(bashCommand2, stdout=subprocess.PIPE)
